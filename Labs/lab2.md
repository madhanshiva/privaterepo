...
1. On the Azure portal, in the **Search resources, services and docs (G+/)** box at the top of the portal, search for **Azure Virtual Desktop (1)** and select **Azure Virtual Desktop (2)**. 

    ![](Media/lab1-11-13.png)

1. on the **Azure Virtual Desktop** page, in the vertical menu bar, in the **Manage** section, select **Host pools (1)**.
